...
% v0.2: add \pr for lower case Probability
...
\newcommand{\PRi}[2]{{\PRSymbol}_{#1} \left( {#2} \right)}
\newcommand{\condPR}[2]{{\PRSymbol} \left({#1} \;\middle|\; {#2} \right)}
\newcommand{\condPRi}[3]{{\PRSymbol}_{#1} \left( {#2} \;\middle|\; {#3} \right)}
\newcommand{\ERW}[1]{{\ERWSymbol} \left[ {#1} \right]}
\newcommand{\ERWi}[2]{{\ERWSymbol}_{#1} \left[ {#2} \right]}
\newcommand{\condERW}[2]{{\ERWSymbol} \left[ {#1} \;\middle|\; {#2} \right]}
\newcommand{\condERWi}[3]{{\ERWSymbol}_{#1} \left[ {#2} \;\middle|\; {#3} \right]}
