...
\theoremstyle{plain}
\newtheorem{thm}{Theorem}[section]              % stellingen worden genummerd volgens de sections
\newtheorem*{hoofdstelling}{Claim}              % een hoofdstelling (zonder nummer)
\newtheorem{lemma}[thm]{Lemma}                  % lemma's worden genummerd als stellingen
\newtheorem{prop}[thm]{Proposition}             % lemma's worden genummerd als stellingen
\newtheorem{eigenschappen}{Properties}
\newtheorem{coro}[thm]{Corollary}
\newtheorem{define}[thm]{Definition}

\newtheorem{example}[thm]{Example}              % worden genummerd als de stellingen
\newtheorem{remark}[thm]{Remark}                % opmerkingen worden niet genummerd
