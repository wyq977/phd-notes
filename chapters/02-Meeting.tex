...
\begin{itemize}
	...
	\item re-do futility analysis with the 'right' e-variables (so you stop for futility if you can reject H1, using an e-variable that takes H1 to be the null hypothesis - this is in many cases not achievable by flipping the original e-variable
 (only do it for conditional e-variable and NML e-variable, not for p-to-e calibration because we do not know how to make p-values with H1 as the null)
 (discuss with Alexander how to treat the case H0: delta=0 vs H1: delta neq 0 because it's unclear how to make an e-variable for H1)
\end{itemize}
