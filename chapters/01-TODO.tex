...
\subsection{Spare task}

This is the stuff that is not priority but rather just for fun, e.g. designing my own web,
writing notes, drawing latex figures, 3d object,

\emph{\Large FUN but not work} so do it when i try to take a break

\begin{itemize}
	\item Create my own draft latex template as a sty or cls? idk, should be done in 
\end{itemize}
