...
This is the stuff that is not priority but rather just for fun, e.g. designing my own web, writing notes, drawing latex figures, 3d object.

\emph{FUN but not work} so do it when i try to take a break
